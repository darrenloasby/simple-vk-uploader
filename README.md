...
- **Addon Docker**: All-in-one container with continuous polling (no host dependencies)
...
The addon container continuously polls your videos directory and uploads up to 5 videos concurrently with automatic WireGuard rotation.
